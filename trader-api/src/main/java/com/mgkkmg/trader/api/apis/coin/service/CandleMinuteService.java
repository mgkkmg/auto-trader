...
@Service
public class CandleMinuteService {

	private final UpbitApiClient upbitApiClient;

	public List<CandleMinuteResponse> getCandlesMinutes() {
		MultiValueMap<String, Object> params = new LinkedMultiValueMap<>();
		params.add("market", "KRW-BTC");
		params.add("count", 200);

		return upbitApiClient.getCandlesMinutes(MediaType.APPLICATION_JSON_VALUE, 5, params);
	}
}
