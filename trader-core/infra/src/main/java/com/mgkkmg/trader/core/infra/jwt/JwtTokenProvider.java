...
public class JwtTokenProvider {
	...
	public String createToken(final String secretKey, final String accessKey) {
	...
	public String createToken(List<String> queryElements, final String secretKey, final String accessKey) {
		final Algorithm algorithm = Algorithm.HMAC256(secretKey);
